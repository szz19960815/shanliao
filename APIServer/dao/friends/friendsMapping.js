var friends = {
    ...
    queryUser: 'select userId,username,register_at,final_chat_record from user_info where userId = ? limit 1',
    queryUserid: 'select * from user_friendship_relation where userId = ?',
    queryAll: 'select * from user_friendship_relation',
